...
const resources = {
    ...
    es: {
        translation: {
            ...
            processing_blockchain: 'Procesando en el Blockchain...',
            azmitado: 'AZMITADO',
            inspector: 'Inspector',
            ...
            wizard_title: 'Nueva Wallet',
            wizard_step1_title: 'Paso 1: Seguridad',
            wizard_step1_desc: 'Tu frase de recuperación es la llave maestra. Si la pierdes, perderás el acceso a tus activos de forma permanente.',
            wizard_step2_title: 'Paso 2: Tu Frase',
            wizard_step2_desc: 'Copia estas 12 palabras y guárdalas fuera de línea.',
            wizard_step3_title: 'Paso 3: Verificar',
            wizard_step3_desc: 'Por favor, ingresa la palabra #',
            wizard_verify: 'Verificar y Finalizar',
            wizard_error_verify: 'La palabra no coincide. Por favor, revisa tu frase.',
            wizard_finish: 'Cartera Protegida',
